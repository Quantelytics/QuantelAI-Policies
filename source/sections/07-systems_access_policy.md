...
5. Any Quantel AI workforce member can request change of access using the process outlined in [§7.2 paragraph 1](#7.2-access-establishment-and-modification).
...
3. Quantel AI maintains a minimum necessary approach to access to Customer data. As such, Quantel AI, including all workforce members, does not readily have access to any ePHI.
...
2. Disallowing transfer of ePHI to workstations is enforced through technical measures.
   ...
   * Configuration settings for enforcing these technical controls are managed by Quantel AI's configuration management tooling, Chef/Salt.
